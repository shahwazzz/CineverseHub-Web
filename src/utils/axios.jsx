...
const instance = axios.create({
    ...
    headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5NTBmMjYxZWZjNzZiMjhhMzBiNmM0NzUzYmIzMzg2MiIsInN1YiI6IjY1Yzc4NDk5NTRhMDk4MDE4NDAxYzY0ZSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.fAw6gsd3mSKnlnao3NETABvnV20tfrfPBDC6KDWeqsg'
    }
});
